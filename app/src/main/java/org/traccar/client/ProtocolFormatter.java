...
public class ProtocolFormatter {
    ...
    public static String formatRequest(String address, String path, int port, boolean secure, Position position) {
        ...
        builder.appendQueryParameter("id", position.getDeviceId())
